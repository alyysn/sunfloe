		...
		<div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
			<div class="carousel-inner">
				...
				<div class="carousel-item <?php if($no==1){echo 'active';} ?>">
					<img class="w-100" src="<?= base_url('assets/upload/caraousel/'.$ya['foto'])?>" alt="Image">
		...
		<div class="row g-5">
			<div class="col-lg-8 mb-t mb-lg-0 wow fadeIn" data-wow-delay="0.5s">
				...
				<div class="row g-4 align-items-center">
					<div class="col-sm-4">
						<img class="img-fluid rounded" src="<?= base_url('assets/upload/konten/'.$yoo['foto'])?>" alt="">
					</div>
					<div class="col-sm-8">
			...
			<div class="col-lg-4 col-12 mx-auto">
				<form action="<?= base_url('beranda')?>" method="post">
					...
					<div class="input-group mb-4 ">
						<input type="text" class="form-control" placeholder="search keyword" autocomplete="off" autofocus
							name="keyword">
